	...
	<div style="padding:10px; width:300px; border:2px solid black; margin:auto">
		<form method="post" action="register_check.php">
			...
			<div class="input-group">
				...
				<input type="password" name="password" class="form-control" placeholder="비밀번호" aria-describedby="sizing-addon1">
			</div>
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">비밀번호</span>
				<input type="password" name="password_r" class="form-control" placeholder="비밀번호" aria-describedby="sizing-addon1">
			</div>
			<h4>성별</h4>
